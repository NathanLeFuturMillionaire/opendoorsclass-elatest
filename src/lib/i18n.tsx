...
const FR: Dict = {
  ...
  "authx.panel.title": "Faites reconnaître votre véritable niveau d'anglais.",
  "authx.panel.desc": "Une évaluation CECRL rigoureuse, de A1 à C2, avec attestation officielle et recommandations personnalisées.",
  "authx.stat.learners": "Apprenants inscrits",
  "authx.stat.certificates": "Attestations délivrées",
  "authx.stat.countries": "Pays représentés",
  "authx.stat.tests": "Tests réalisés",
  "authx.certified.title": "Derniers apprenants certifiés",
  "authx.certified.desc": "Rejoignez les apprenants qui ont déjà évalué leur anglais avec OpenDoorsClass.",
  "authx.certified.badge": "Attestations vérifiées",
  "authx.firstName": "Prénom",
  "authx.lastName": "Nom",
  "authx.gender": "Genre",
  "authx.gender.placeholder": "Sélectionnez votre genre",
  "authx.gender.male": "Homme",
  "authx.gender.female": "Femme",
  "authx.gender.other": "Autre",
  "authx.gender.specify": "Veuillez préciser",
  "authx.country": "Pays ou région",
  "authx.country.placeholder": "Sélectionnez votre pays",
  "authx.email.invalid": "Adresse e-mail invalide.",
  "authx.pw.show": "Afficher le mot de passe",
  "authx.pw.hide": "Masquer le mot de passe",
  "authx.pw.rule.length": "8 caractères minimum",
  "authx.pw.rule.upper": "Une majuscule",
  "authx.pw.rule.lower": "Une minuscule",
  "authx.pw.rule.digit": "Un chiffre",
  "authx.pw.rule.special": "Un caractère spécial",
  "authx.pw.weak": "Faible",
  "authx.pw.fair": "Moyen",
  "authx.pw.good": "Bon",
  "authx.pw.strong": "Solide",
  "authx.pw.excellent": "Excellent",
  "authx.confirm": "Confirmer le mot de passe",
  "authx.confirm.match": "Les mots de passe correspondent",
  "authx.confirm.nomatch": "Les mots de passe ne correspondent pas.",
  "authx.remember": "Se souvenir de moi",
  "authx.forgot": "Mot de passe oublié ?",
  "authx.forgot.needEmail": "Saisissez d'abord votre adresse e-mail.",
  "authx.forgot.sent": "Lien de réinitialisation envoyé.",
  "authx.trust.secure": "Authentification sécurisée",
  "authx.trust.encrypted": "Données personnelles chiffrées",
  "authx.trust.trusted": "Adopté par les apprenants d'Afrique et d'ailleurs",
  ...
  "dash.recharge": "Acheter un nouveau crédit",
  "dash.buy": "Acheter 1 crédit",
  ...
  "dash.buy.one": "Acheter 1 crédit pour commencer",
  ...
  "pay.success.desc": "Votre paiement a bien été confirmé. {n} crédit a été ajouté à votre compte. Vous pouvez désormais commencer votre test de niveau.",
  ...
  "notif.deleteRead": "Supprimer les notifications lues",
  "notif.deleteRead.confirm": "Cette action supprimera définitivement toutes vos notifications déjà lues.",
  "notif.cancel": "Annuler",
  "notif.confirm": "Confirmer",
  "notif.viewAll": "Toutes les notifications",
  "notif.loadMore": "Charger plus",
  "notif.filter.all": "Toutes",
  "notif.filter.unread": "Non lues",
  "notif.filter.payments": "Paiements",
  "notif.filter.achievements": "Réussites",
  "notif.filter.leaderboard": "Classement",
  "notif.filter.system": "Système",
  "notif.group.today": "Aujourd'hui",
  "notif.group.yesterday": "Hier",
  "notif.group.earlier": "Plus tôt",
  "notif.time.now": "À l'instant",
  "notif.time.min": "min",
  "notif.time.hour": "h",
  "notif.time.day": "jours",
};
