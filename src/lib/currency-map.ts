...
// Source of truth for the automatic currency conversion of displayed prices.
export const COUNTRY_CURRENCY: Record<string, string> = {
  ...
  PE: "PEN", PF: "XPF", PG: "PGK", PH: "PHP", PK: "PKR", PL: "PLN", PM: "EUR", PR: "USD",
  PS: "ILS", PT: "EUR", PW: "USD", PY: "PYG", QA: "QAR", RE: "EUR", RO: "RON", RS: "RSD",
  RU: "RUB", RW: "RWF", SA: "SAR", SB: "SBD", SC: "SCR", SD: "SDG", SE: "SEK", SG: "SGD",
  SH: "SHP", SI: "EUR", SJ: "NOK", SK: "EUR", SL: "SLE", SM: "EUR", SN: "XOF", SO: "SOS",
  SR: "SRD", SS: "SSP", ST: "STN", SV: "USD", SX: "ANG", SY: "SYP", SZ: "SZL", TC: "USD",
  ...
  VU: "VUV", WF: "XPF", WS: "WST", XK: "EUR", YE: "YER", YT: "EUR", ZA: "ZAR", ZM: "ZMW",
  ZW: "ZWG",
};

// Countries whose national currency is the CFA franc (same value as the base price).
export const CFA_CURRENCIES = new Set(["XAF", "XOF"]);

// Currencies without decimal subunits in common usage.
export const ZERO_DECIMAL_CURRENCIES = new Set([
  "XAF", "XOF", "XPF", "JPY", "KRW", "VND", "CLP", "ISK", "UGX", "RWF",
  "GNF", "KMF", "DJF", "BIF", "PYG", "VUV", "IQD", "MGA",
]);

export function currencyForCountry(country: string | null | undefined): string {
  if (!country) return "XAF";
  return COUNTRY_CURRENCY[country.toUpperCase()] ?? "XAF";
}
