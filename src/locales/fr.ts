...
const fr: Dict = {
  ...
  "about.title.b": "une même conviction.",
  "about.desc": "OpenDoorsClass est porté par une équipe qui enseigne, évalue et accompagne au quotidien.",
  "about.hint": "Faites glisser la carte ou utilisez les flèches pour découvrir l'autre profil.",
  "about.next": "Voir le profil suivant",
  "about.prev": "Voir le profil précédent",
  "about.hulda.name": "IBALA BISSELO Hulda Christ Girelle",
  "about.hulda.p1": "Elle aime l'anglais et est toujours engagée dans son apprentissage. Elle croit profondément que cette langue peut ouvrir des portes inimaginables et que son apprentissage devrait être une priorité pour chacun.",
  "about.hulda.p2": "En tant que co-fondatrice d'OpenDoorsClass, elle participe activement à l'évolution de l'entreprise et contribue à son développement.",
